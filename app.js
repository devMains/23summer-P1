...
app.post('/api/posts', (req, res) => {
    ...
    const newPost = new Post({title, content, postTime: getCurrentDateTime()});
    newPost.save()
    ...
    function getCurrentDateTime() {
        ...
        const seconds = now.getSeconds().toString().padStart(2, '0');            return `${year}-${month}-${day} ${hours}:${minutes}:${seconds}`;
    };
});
